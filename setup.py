...
setup(
    ...
    description="Python wrapper for an APA102 LED strip",  # Optional
    ...
    url="https://github.com/Freemanium/stripctl",  # Optional
    # This should be your name or the name of the organization which owns the
    # project.
    author="Christian Volkmann",  # Optional
    ...
    keywords="apa102 ledstrip led",  # Optional
